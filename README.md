...
Review GitHub's API documentation for the list user repositories endpoint to understand how this endpoint works. https://developer.github.com/v3/repos/#list-user-repositories 
